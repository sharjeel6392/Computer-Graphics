...
static const char *vshader = "v130.vert";
static const char *fshader = "v130.frag";
...
const char *w_title = (char *) "Polygon Fill";
...
//
// Two options:  physical keys, or exact character codes
///

///
// Physical keys (case insensitive - A and a, @ and 2, etc.
